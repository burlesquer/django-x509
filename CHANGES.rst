...
- Fixed `bug in admin <https://github.com/burlesquer/django-x509/issues/119>`_
...
- [fix] Fixed rendering of CA and cert edit pages when in popup mode
  (`issue #113 <https://github.com/burlesquer/django-x509/issues/113>`_)
...
- Improved documentation on `how to extend django-x509 <https://github.com/burlesquer/django-x509#extending-django-x509>`_
...
* `#36 <https://github.com/burlesquer/django-x509/issues/36>`_:
  [requirements] Added support for django 2.1
* `#44 <https://github.com/burlesquer/django-x509/issues/44>`_:
  [models] Improved error message format #44
* `#61 <https://github.com/burlesquer/django-x509/pull/61>`_:
  Bumped supported Django version to 2.2 and Python version to 3.7
* `#63 <https://github.com/burlesquer/django-x509/pull/63>`_:
...
* `#41 <https://github.com/burlesquer/django-x509/pull/41>`_:
  [requirements] Added support for django 2.1
...
* `#24 <https://github.com/burlesquer/django-x509/issues/24>`_:
  [qa] Added django 2.0 & dropped django 1.10
* `#25 <https://github.com/burlesquer/django-x509/issues/25>`_:
  [admin] Automatically select ``certificate`` and ``private_key`` on click
* `#33 <https://github.com/burlesquer/django-x509/issues/33>`_:
